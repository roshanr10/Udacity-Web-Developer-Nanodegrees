...
# Based off of `Conference`, `ConferenceForm`, and `ConferenceForms`:
# lines 58-90

# Properties as listed within the `Getting Started` document
...
# Based off of `ConferenceQueryForm`, and `ConferenceQueryForms`:
# lines 112-121
