...
menuItem3 = MenuItem(
    user_id=1,
    name="Gyoza",
    description="light seasoning of Japanese gyoza with salt and soy " +
    "sauce, and in a thin gyoza wrapper",
    price="$9.95",
    course="Entree",
    restaurant=restaurant1)
...
menuItem5 = MenuItem(
    user_id=1,
    name="Tonkatsu Ramen",
    description="Noodles in a delicious pork-based broth with a " +
    "soft-boiled egg",
    price="$7.95",
    course="Entree",
    restaurant=restaurant1)
...
menuItem2 = MenuItem(
    user_id=1,
    name="Broiled salmon",
    description="Salmon fillet marinated with fresh herbs and broiled " +
    "hot & fast",
    price="$10.95",
    course="Entree",
    restaurant=restaurant1)
...
menuItem4 = MenuItem(
    ...
    " mix(chilli, tamarind among others) and slow cooked in a cylindrical" +
...
menuItem1 = MenuItem(
    ...
    description="Marinated Pork, Rice, Beans, Avocado, Cilantro, " +
    "Salsa, Tortilla",
    price="$5.95",
    course="Entree",
    restaurant=restaurant1)
